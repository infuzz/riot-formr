(function () {
  ...
  var icheckbox = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr11></jlabel><jtooltip expr12></jtooltip><jhelp expr13></jhelp><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div class="aaad-inline"><template expr14></template></div>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template(
            '<div class="row"><div expr15 class="fucfirst col-auto mb-2"></div><div class="col-auto"><label expr16><span expr17 class="mr-1"></span><jtooltip expr18></jtooltip><jhelp expr19></jhelp><input expr20 class="form-control"/><span expr21></span></label></div><div expr22 class="fucfirst col-auto mb-2"></div><div class="fucfirst col-auto mb-2"><jtooltip expr23></jtooltip><jhelp expr24></jhelp></div></div>',
            [{
  ...
  var iselect = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr90></jlabel><jtooltip expr91></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div expr92></div><div expr93></div><div class="input-group mb-3"><jaddon expr94 placement="left"></jaddon><select expr95><template expr96></template></select><jaddon expr98 placement="right"></jaddon></div><jhelp expr99></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template('<option expr97><!----></option>', [{
  ...
  var itexteditor = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr68></jlabel><jtooltip expr69></jtooltip><template expr70></template><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div expr72></div><jhelp expr77></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template(
            '<button expr71 type="button" style="text-transform: capitalize;"><!----><span class="aaainputFeedback"></span></button>',
            [{
          ...
          'template': template(
            '<div class="texteditor"></div><input expr73 type="hidden" class="form-control"/><input id="x" value="Editor content goes here" type="hidden" name="content"/><trix-editor expr74 input="x"></trix-editor><div expr75 class="h-100 input-group-append"></div>',
            [{
              'expressions': [{
                'type': expressionTypes.ATTRIBUTE,
                'name': 'class',
              ...
              'template': template(
                '<button expr76 type="button" class="btn btn-info"><i class="fas fa-language"></i></button>',
                [{
  ...
  var jaddon = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<div expr105 class="h-100 input-group-prepend"></div><div expr107 class="h-100 input-group-append"></div>',
        [{
          'type': bindingTypes.IF,
          ...
          'template': template(
            '<span class="input-group-text" id="basic-addon1"><jicon expr106></jicon></span>',
            [{
              'type': bindingTypes.TAG,
              'getComponent': getComponent,
          ...
          'template': template('<ibutton expr108></ibutton>', [{
            'type': bindingTypes.EACH,
            'getKey': null,
            'condition': null,
