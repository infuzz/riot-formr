(function () {
  ...
  var formr = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<form expr25 novalidate><button expr26 type="button">Go</button><button expr27 type="button">set</button><div expr28></div></form>',
        [{
          ...
          'template': template('<div expr29 class="form-group"><div expr30></div></div>', [{
  ...
  var ibutton = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<button expr7 type="button" style="text-transform: capitalize;"><jicon expr8></jicon><!----><jtooltip expr9></jtooltip></button><jhelp expr10></jhelp>',
        [{
  ...
  var icheckbox = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr127></jlabel><jtooltip expr128></jtooltip><jhelp expr129></jhelp><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div class="aaad-inline"><template expr130></template></div>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template(
            '<div class="row"><div expr131 class="fucfirst col-auto mb-2"></div><div class="col-auto"><label expr132><span expr133 class="mr-1"></span><jtooltip expr134></jtooltip><jhelp expr135></jhelp><input expr136 class="form-control"/><span expr137></span></label></div><div expr138 class="fucfirst col-auto mb-2"></div><div class="fucfirst col-auto mb-2"><jtooltip expr139></jtooltip><jhelp expr140></jhelp></div></div>',
            [{
  ...
  var icolorpicker = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr114></jlabel><jtooltip expr115></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><jhelp expr116></jhelp><div expr117></div><input expr118 type="hidden" class="form-control"/>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
  ...
  var imultiselect = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<select expr55 multiple class="hide"><template expr56></template></select><jlabel expr58></jlabel><jtooltip expr59></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small>',
        [{
          ...
          'template': template('<option expr57><!----></option>', [{
  ...
  var ipassword = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr42></jlabel><jtooltip expr43></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div class="input-group"><jaddon expr44 placement="left"></jaddon><input expr45 type="password" autocomplete="on"/><jaddon expr46 placement="right"></jaddon></div><jhelp expr47></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
  ...
  var irange = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr48></jlabel><jtooltip expr49></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div class="input-group"><input expr50 type="range"/></div><jhelp expr51></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
  ...
  var irow = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<div class="row"><template expr52></template></div>', [{
        'type': bindingTypes.EACH,
        'getKey': null,
        'condition': null,

        'template': template('<div expr53><div expr54></div></div>', [{
  ...
  var iselect = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr119></jlabel><jtooltip expr120></jtooltip><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div class="input-group"><jaddon expr121 placement="left"></jaddon><select expr122><template expr123></template></select><jaddon expr125 placement="right"></jaddon></div><jhelp expr126></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template('<option expr124><!----></option>', [{
  ...
  var itext = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr78></jlabel><jtooltip expr79></jtooltip><template expr80></template><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div expr82></div><jhelp expr89></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template(
            '<button expr81 type="button" style="text-transform: capitalize;"><!----><span class="aaainputFeedback"></span></button>',
            [{
          ...
          'template': template(
            '<jaddon expr83 placement="left"></jaddon><input expr84 autocomplete="on"/><textarea expr85></textarea><div expr86 class="h-100 input-group-append"></div><jaddon expr88 placement="right"></jaddon>',
            [{
              'expressions': [{
                'type': expressionTypes.ATTRIBUTE,
                'name': 'class',
  ...
  var itexteditor = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<jlabel expr145></jlabel><jtooltip expr146></jtooltip><template expr147></template><span class="inputFeedback"></span><small class="inputFeedbackMsg"></small><div expr149></div><jhelp expr154></jhelp>',
        [{
          'type': bindingTypes.TAG,
          'getComponent': getComponent,
          ...
          'template': template(
            '<button expr148 type="button" style="text-transform: capitalize;"><!----><span class="aaainputFeedback"></span></button>',
            [{
          ...
          'template': template(
            '<div expr150></div><input expr151 type="hidden" class="form-control"/><div expr152 class="h-100 input-group-append"></div>',
            [{
              'expressions': [{
                'type': expressionTypes.ATTRIBUTE,
                'name': 'class',
              ...
              'template': template(
                '<button expr153 type="button" class="btn btn-info"><i class="fas fa-language"></i></button>',
                [{
  ...
  var jaddon = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<div expr141 class="h-100 input-group-prepend"></div><div expr143 class="h-100 input-group-append"></div>',
        [{
          'type': bindingTypes.IF,
          ...
          'template': template('<span class="input-group-text"><jicon expr142></jicon></span>', [{
            'type': bindingTypes.TAG,
            'getComponent': getComponent,
          ...
          'template': template('<ibutton expr144></ibutton>', [{
            'type': bindingTypes.EACH,
            'getKey': null,
            'condition': null,
  ...
  var jhelp = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<small expr100 class="text-muted mb-1 mr-1"></small>', [{
        'type': bindingTypes.IF,
  ...
  var jlabel = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<label expr109 class="label fucfirst"><!----></label><span expr110 class="inputRequired mx-1"></span>',
        [{
  ...
  var jtooltip = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<div expr112 class="ftooltip"></div>', [{
        'type': bindingTypes.IF,
        ...
        'template': template(
          '<i class="far fa-question-circle mx-1"></i><div expr113 class="ftooltipText"><!----></div>',
          [{
